...
public class SideScroller extends Application{
	...
	public void init() throws Exception{
		...
		ps.setScale(SCALE);
		Player player=new Player(width/2,height/2,20*SCALE,20*SCALE,ps);
		player.setInput(input);

		List<Entity> players =board.players();
		players.add(player);
		Region statusBar=this.createStatusBar();
		Region optionsBar=this.createOptionsBar();
	...
	public CheckMenuItem createCheckMenuItem( String text, boolean isSelected, BooleanProperty binding){
		...
		BooleanProperty b1 = new SimpleBooleanProperty( checkItem.isSelected());
		binding.bind(b1);
